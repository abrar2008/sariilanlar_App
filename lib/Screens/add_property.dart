...
import 'package:sariilanlar/utils/banner_for_add_property.dart';
import 'package:sariilanlar/utils/bathrooms_container.dart';
import 'package:sariilanlar/utils/bedrooms_container.dart';
            ...
            child: Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      _countryValue = newValue as String;
                    });
                  },
              ...
              child: Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton(
                    ...
                    onChanged: (newValue) {
                      setState(() {
                        _provinceValue = newValue as String;
                      });
                    },
